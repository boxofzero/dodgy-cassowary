...
const baseCharLevellingMaterialsCount: LevelMaterials[] = [
  { level: '1', materials: {} },
...
export interface ActiveSkillLevelMaterials {
  level: number
  materials: Materials
}

export const activeSkillLevellingMaterialsCount: ActiveSkillLevelMaterials[] = [
  { level: 1, materials: {} },
  {
    level: 2,
    materials: {
...
export interface PassiveSkillMaterials {
  materials: Materials
}

export const passiveSkillLevellingMaterialsCount: Record<string, PassiveSkillMaterials> = {
  passive_skill_1: {
    materials: {
      shell_credit: 10000,
      tiered_enemy_drop_weapon_skill_material: {
...
export function charLevellingMaterialsCount(characterName = ''): LevelMaterials[] {
  if (typeof characterName === 'string' && characterName.toLowerCase().startsWith('rover')) {
    const data = JSON.parse(JSON.stringify(baseCharLevellingMaterialsCount))
